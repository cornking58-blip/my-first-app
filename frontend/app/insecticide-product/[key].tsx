...
export default function InsecticideDetailScreen() {
  ...
  const fetchProduct = async () => {
    ...
    try {
      const response = await axios.get(`${API_URL}/api/insecticides/${encodeURIComponent(key)}`);
