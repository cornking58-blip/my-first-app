...
const styles = StyleSheet.create({
  ...
  logoB: { color: '#374151' },
  logoAI: { color: '#3B82F6', fontWeight: '900' },
  logoKov: { color: '#374151' },
  ...
  filterButtonActive: { backgroundColor: '#D1FAE5' },
  filterText: { marginLeft: 6, fontSize: 14, color: '#6B7280' },
  filterTextActive: { color: '#059669' },
  searchButton: {
  ...
  clearText: { marginLeft: 12, fontSize: 14, color: '#6B7280', textDecorationLine: 'underline' },
  compareButton: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#8B5CF6',
  ...
  compareHint: { fontSize: 13, color: '#6B7280', fontStyle: 'italic' },
  ...
  productName: { fontSize: 17, fontWeight: '600', color: '#111827', flexShrink: 1 },
  formulationBadge: {
    backgroundColor: '#F3F4F6',
    paddingHorizontal: 8,
    paddingVertical: 2,
  ...
  formulationText: { fontSize: 12, color: '#6B7280', fontWeight: '500' },
  ...
  substances: { fontSize: 14, color: '#4B5563', lineHeight: 20, marginBottom: 8 },
  manufacturerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  manufacturer: { fontSize: 13, color: '#6B7280', marginLeft: 6, flex: 1 },
  cardFooter: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  applicationsText: { fontSize: 13, color: '#6B7280', marginLeft: 6 },
  cardContent: { flex: 1 },
  compareSelectButton: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  compareSelectButtonDisabled: { backgroundColor: '#F3F4F6', borderColor: '#D1D5DB' },
  compareSelectText: { fontSize: 12, fontWeight: '600', color: '#8B5CF6', marginLeft: 4 },
  compareSelectTextActive: { color: '#FFFFFF' },
  compareSelectTextDisabled: { color: '#D1D5DB' },
