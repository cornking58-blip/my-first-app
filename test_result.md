...
agent_communication:
  ...
  - agent: "main"
    message: "Добавлен раздел ПРОТРАВИТЕЛИ СЕМЯН. Новые эндпоинты: POST /api/admin/import-seed-treatments, GET /api/seed-treatments/search, GET /api/seed-treatments/{product_key}, POST /api/seed-treatments/compare-advanced. Импортировано 309 записей (284 уникальных). Обновлён /api/stats для трёх разделов. Протестируйте seed-treatments эндпоинты."
  - agent: "testing"
